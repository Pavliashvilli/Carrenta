...
public class Renta4 extends AppCompatActivity{
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView calendarView, int  year, int month, int  dayOfMonth) {
                ...
                if (date1.compareTo(date2) < 0 && date1.length()==date2.length()) {
                    ...
                    Toast toast = Toast.makeText(Renta4.this, "Выберите другую дату",Toast.LENGTH_LONG);
                    toast.show();
    ...
    public void onMyClick(View view) {
        Toast toast = Toast.makeText(Renta4.this, "Complete", Toast.LENGTH_LONG);
        toast.show();
    ...
    public void parse () {
        try {
            ...
            if (col_days != 0) {
                ...
                Toast toast = Toast.makeText(Renta4.this, "col_days problem", Toast.LENGTH_LONG);
                toast.show();
    ...
    public void constract (){
        Level4 name = new Level4();
        Level4 coast = new Level4();
        int car_coast = coast.coast_Audi;
        int result = car_coast * col_days;
        res = String.valueOf(result) ;
        car_naming = name.car_Audi;
    ...
    public void onBackPressed (){
        try {
            Intent intent = new Intent(Renta4.this,Level2.class);
