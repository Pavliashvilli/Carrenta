...
public class Renta2 extends AppCompatActivity {
    // private FloatingActionButton btnwishes;
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView calendarView, int  year, int month, int  dayOfMonth) {
                ...
                if (date1.compareTo(date2) < 0 && date1.length()==date2.length()) {
                    ...
                    Toast toast = Toast.makeText(Renta2.this, "Выберите другую дату",Toast.LENGTH_LONG);
                    toast.show();
    ...
    public void onMyClick(View view) {
        Toast toast = Toast.makeText(Renta2.this, "Complete", Toast.LENGTH_LONG);
        toast.show();
    ...
    public void parse () {
        try {
            ...
            if (col_days != 0) {
                ...
                Toast toast = Toast.makeText(Renta2.this, "col_days problem", Toast.LENGTH_LONG);
                toast.show();
    ...
    public void constract (){
        Level2 name = new Level2();
        Level2 coast = new Level2();
        int car_coast = coast.coast_Nissan;
        int result = car_coast * col_days;
        res = String.valueOf(result) ;
        car_naming = name.car_Nissan;
    ...
    public void onBackPressed (){
        try {
            Intent intent = new Intent(Renta2.this,Level2.class);
