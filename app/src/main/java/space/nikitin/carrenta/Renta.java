...
public class Renta extends AppCompatActivity {
   ...
   // private FloatingActionButton btnwishes;
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView calendarView, int  year, int month, int  dayOfMonth) {
                ...
                if (date1.compareTo(date2) < 0 && date1.length()==date2.length()) {
                    ...
                    Toast toast = Toast.makeText(Renta.this, "Выберите другую дату",Toast.LENGTH_LONG);
                    toast.show();
    ...
    public void onMyClick(View view) {
            Toast toast = Toast.makeText(Renta.this, "Complete", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void parse () {
        ...
        constract ();
            ...
            Toast toast = Toast.makeText(Renta.this, "col_days problem", Toast.LENGTH_LONG);
            toast.show();
    ...
    public void constract (){
        Level1 name = new Level1();
        Level1 coast = new Level1();
        int car_coast = coast.coast_Aston;
        int result = car_coast * col_days;
        res = String.valueOf(result) ;
        car_naming = name.car_Aston;
    ...
    public void onBackPressed (){
        try {
            Intent intent = new Intent(Renta.this,Level1.class);
